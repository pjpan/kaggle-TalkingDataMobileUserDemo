...
device_country <- readRDS(file = './input/deviceid_country.rds')
device_district <- readRDS(file = './input/deviceid_district.rds')
device_hour_pct <- readRDS(file = './input/device_hour_pct.rds')
device_logintimes <- readRDS(file = './input/device_logintimes.rds')
...
device_appid_active_pct <- readRDS(file = './input/device_appid_active_pct.rds')
device_appid_summary <- readRDS(file = './input/device_appid_summary.rds')
device_brandmodels_onehot <- readRDS(file = './input/device_brandmodels_onehot.rds')
device_brands_onehot <- readRDS(file = './input/device_brands_onehot.rds')
